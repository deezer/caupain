package com.deezer.dependencies.cli.serialization
...
private enum class DefaultRepositories(val key: String, val repository: Repository) {
    GOOGLE("google", com.deezer.dependencies.model.DefaultRepositories.google),
    MAVEN_CENTRAL("mavenCentral", com.deezer.dependencies.model.DefaultRepositories.mavenCentral),
    GRADLE_PLUGINS(
        "gradlePlugins",
        com.deezer.dependencies.model.DefaultRepositories.gradlePlugins
    ),
}
